...
const sendEmailWithTemplate = async ({ to, subject, templateName, data, replyTo }) => {
    ...
    const emailData = {
        ...data,
        siteUrl: process.env.FRONTEND_URL || 'http://localhost:10000', // Default to PORT 10000 if not set
        logoUrl: process.env.EMAIL_LOGO_URL || 'https://i.ibb.co/XxJgqVKp/IMG-20250701-WA0003.jpg' // Use ENV for logo, with a fallback
    };
